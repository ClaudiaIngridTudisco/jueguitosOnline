...
class PiezasBag{
    ...
    init(){
        for(let i = 0; i<3; i++){
            this.threeNextPiezas.push(this.getNextPieza());
        }
    }
    fillBag(){
        const piezasType = [
        ...
        this.bag.length = 0;
        piezasType.forEach((type)=>{
            this.bag.push(new Pieza(
    ...
    nextPieza(){
       const next = this.threeNextPiezas.shift();
       this.threeNextPiezas.push(this.getNextPieza());
       return next;
    }
    getThreeNextPiezas(){
        return this.threeNextPiezas;
    }
    reset(){
        this.bag = [];
        this.threeNextPiezas = [];
...
export {Position, Pieza, PiezaType, PiezasBag}